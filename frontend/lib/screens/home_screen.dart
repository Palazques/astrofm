  ...
  Widget _buildTodaysResonance() {
    ...
    return GlassCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Header row with title and cosmic weather
          Row(
          ...
          // Signal cards - Resonance, Feedback, Dissonance
          ...
          // Cosmic weather footer
          if (_dailyReading?.cosmicWeather != null) ...[
            const SizedBox(height: 4),
            Text(
              _dailyReading!.cosmicWeather,
              style: GoogleFonts.spaceGrotesk(
                fontSize: 11,
