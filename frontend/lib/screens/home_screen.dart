...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadCachedPlaylist() async {
    // Load dataset playlist from cache
  ...
  Future<void> _generatePlaylist() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        await storageService.saveDatasetPlaylist(result.toJson());
  ...
  Widget _buildTodaysResonance() {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: 280, // Height for 3-part messages
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // Show cosmic and advice only if they exist
                if (cosmicText.isNotEmpty || adviceText.isNotEmpty) ...[
                  ...
                  // PART 2: Cosmic message
                  if (cosmicText.isNotEmpty)
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                if (_datasetPlaylist != null || _spotifyLibraryTracks.isNotEmpty || _generatedPlaylist != null)
                  Container(
